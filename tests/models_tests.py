...
class ModelsTest(unittest.TestCase):
    ...
    def test_task_toJSON(self):
        ...
        self.assertEquals({'id':1,'title':'title1','detail':'detail','status':'DONE','price':1,'estimate':4,'team':{'name':'Log','color':'2a33d8'},'owner':{'name':'Mike','gravater':'91f376c4b36912e5075b6170d312eab5'},'partner':{}},task.toJSON())
